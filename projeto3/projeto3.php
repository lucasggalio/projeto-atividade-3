...
<body>
    <div class="container mx-auto bg-light mt-1 w-90">
        <header class="row">
            ...
            <div class="col-sm-3">
                <img src="logoXpto.jpeg" width="50" height="50" alt="logotipo xpto circulo geometrico com cores arco iris e um S no centro. ">
            </div>
            ...
            <form action="#">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <span class="error" style="display: none;" id="erroNome">Campo nome obrigatório</span>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <span class="error" style="display: none;" id="erroEmail">Campo e-mail obrigatório</span>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <span class="error" style="display: none;" id="erroMensagem">Campo mensagem obrigatório</span>
